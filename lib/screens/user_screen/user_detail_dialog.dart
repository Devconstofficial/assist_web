                    ...
                    controller.isLoadingUser.value
                        ...
                        : Column(
                          children: [
                            ...
                            if (controller.user.value.roles.last == "applicant")
                              CustomButton(
                                height: 61,
                            ...
                            CustomButton(
                              ...
                              title:
                                  controller.user.value.blocked == false
                                      ? "Block ${controller.user.value.roles.last == "applicant" ? "User" : "Donar"}"
                                      : "Unblock ${controller.user.value.roles.last == "applicant" ? "User" : "Donar"}",
                              onTap: () {
